const settings = {
  ...
  blueCarryOffset:  { value: 1,     min: -30,  max: 20,   step: 1,    label: 'Blue Carry Y' },
  ...
  shadesYL:      { value: 17,   min: 0,    max: 60,   step: 1,    label: 'Shades Y (left)' },
  shadesXR:      { value: 9,    min: -30,  max: 30,   step: 1,    label: 'Shades X (right)' },
  shadesYR:      { value: 17,   min: 0,    max: 60,   step: 1,    label: 'Shades Y (right)' },
