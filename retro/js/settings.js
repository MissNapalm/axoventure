const settings = {
  ...
  carryOffset:  { value: 7,     min: -30,  max: 20,   step: 1,    label: 'Carry Y Offset' },
  ...
  carryJumpY:   { value: -12,   min: -40,  max: 40,   step: 1,    label: 'Carry Jump Y' },
  flippedGndY:  { value: 4,     min: -20,  max: 20,   step: 1,    label: 'Flip Ground Y' },
